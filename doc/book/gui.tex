...
the standard elements of \index{graphical user
interface}graphical user interfaces are not built-in to the language.
...
\>   \ \ \ local b, l := Label({\textquotedbl}label=Click to
...
This class contains several \index{tab,
