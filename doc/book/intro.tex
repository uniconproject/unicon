...
Icon is a \index{very high-level language}very high-level language from
...
an earlier language, \index{SNOBOL4}SNOBOL4. Icon
...
least painful\index{Daniel Berry} programming language
