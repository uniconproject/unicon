...
\graph [ grow right sep=8mm,simple, branch down={4.3*\rad}]{
  ...
  / --[In] entry -!-
  {
    ...
    rc0 -- rc1/record[T] --  rc2/"("[T] --/-- rc3/"\guillemets{name}"[T]
        -- rc4/","[T] -!- rc5 -- rc6/")"[T] -- rcx,
  ...
  rc2.east --[uxd=0] rc5; % yes, a null record is allowed.
  rc3.east --[uxd=0] rc5; rc4.east --[d-xu=0] rc3.west;
...
\graph [ grow right sep=5.6mm,simple, branch down={4*\rad}]{
  ...
  / --[In] / -- entry -!-
  {
    {pb1/local[T],pb2/static[T]} -!-/-- pb3/"\guillemets{name}"[T] -- pb4/","[T]
    -!-/-!- pb5/";"[T] -- pb6/initial[T] -- pb7/expr[NT] -- /
    -- pb8/";"[T] -- pb9/expr[NT] --/-- pbx,
  }
  -- exit --[Out] /;
  %
  entry -- pb1.west; pb1.east -- pb3.west;
  entry --[dx] pb2.west; pb2.east --[ux]pb3.west;
  pb4.east --[u-xd=0] pb3.west;
  entry --[dxu=4*\rad] exit;
  pb3.east --[dxu=4*\rad] pb5.west;
  pb3.east --[dxu=4*\rad] pb8.west;
  pb5.east --[u-xd=0.5*\rad] entry;
