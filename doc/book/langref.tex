...
Cryptographic handles, SSH files, TLS sockets, and network sockets may
be subscripted by a status field name for a non-destructive peek
(\texttt{h["type"]}, \texttt{c["exitstatus"]}, \texttt{f["ttl"]},
\texttt{conn["cipher"]}); an unknown name is a runtime error
(1302 crypto, 1326 TLS, 1331 SSH, 1310 sockets) and an
...
handle, SSH file, TLS socket, or network socket; \texttt{f[k]} peeks
