...
in the entries for \index{constructor}constructors that
...
\index{file}Files are system resources corresponding to data on
secondary storage, areas on users{\textquotesingle} displays, network
connections, or \index{database}databases. Operations on files
...
Local variables exist and are visible within a single procedure or method
