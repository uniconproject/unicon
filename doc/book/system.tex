...
\index{chmod()}\texttt{chmod()} function only succeeds the owner of a
...
\texttt{{\textquotedbl}p{\textquotedbl}} (for \index{pipe}pipe) to
...
The call to \texttt{open({\textquotedbl}:1888{\textquotedbl},
