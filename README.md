...
**Preprocessor:** multi-line strings, function-like macros, and built-in `assert` / `assert_not` are documented in [**UTR #24** — `doc/utr/utr24.rst`](doc/utr/utr24.rst) (*The Unicon Preprocessor*).
