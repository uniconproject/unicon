...
%--[DonW]  Update this diagram to use block pointers.
%--[DonW]  As this is their first appearance, consider two diagrams
%--[DonW]  One Icon, one Unicon, with a brief explanation.
\put(140,96){\blkbox{record}{32}}
\put(140,96){\rightboxlabels{title}{size of block in bytes}}
\put(140,64){\dvptrbox{proc}{np}{50}{record constructor}}
...
\put(140,128){\blkbox{record}{40}}
\put(140,96){\dvptrbox{proc}{np}{50}{record-constructor block}}
\put(140,64){\dvptrbox{5}{}{50}{"chair"}}
\put(140,32){\dvptrbox{4}{}{50}{"noun"}}
\put(140,0){\dvbox{integer}{n}{4}}
\end{picture}
...
%-% {\ttfamily\mdseries
%-% \ \ \ \};}
%--[DonW]  Preserve the colouring (above) in the code (below).
\iconcode{
\>struct descrip \{\ \ /* descriptor */\\
\>\>word dword;\ \ /*\ \ type field */\\
\>\>union \{\\
