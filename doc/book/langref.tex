...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf \&eventsource := co{}-expression \hfill source of program execution events}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf \&regions : integer* \hfill region sizes}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf \&subject := string \hfill string scanning subject}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf \textbf{class} name [: superclass]* (fields) methods [initially] end \hfill class declaration}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf \textbf{every} \textit{expr1} [do \textit{expr2}] \hfill generate all results}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf \textbf{global} \textit{var} [, \textit{var}]* \hfill declare global variables}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf \textbf{if} \textit{expr} then \textit{expr2} [else \textit{expr3}] \hfill conditional expression}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf \textbf{import} \textit{name} [, \textit{name}]* \hfill import package}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf \textbf{invocable} \textit{procedure} [, \textit{procedure}]* \hfill allow string invocation}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf \textbf{link} \textit{filename} [, \textit{filename}]* \hfill link code module}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf \textbf{local} \textit{var} [:=\textit{initializer} ] [, \textit{var}\ [:=\textit{ initializer ] ]}* \hfill declare local variables}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf not expr \hfill negate expression failure}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf \textbf{static} \textit{var} [, \textit{var}]* \hfill declare static variables}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf \textbf{suspend} \textit{expr} [do \textit{expr}] \hfill produce result from invocation}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf \textbf{until} \textit{expr1} [do \textit{expr2}] \hfill loop until success}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf \textbf{while} \textit{expr1} [do \textit{expr2}] \hfill loop until failure}
...
\noindent {\bf \textit{object} \$ superclass .name (params) \hfill superclass method invocation}
\index{superclass}
...
\noindent {\bf string1 {\textless}{\textless}= string2 \hfill string less or equal}

\noindent {\bf string1 {\textgreater}{\textgreater} string2 \hfill string greater than}

\noindent {\bf string1 {\textgreater}{\textgreater}= string2 \hfill string greater or equal}
...
\noindent {\bf \textbf{[:} expr \textbf{:]} \hfill list comprehension}
\index{list creation}
...
\noindent {\bf expr1 \textbf{[} expr2 +: expr3 \textbf{]} \hfill forward relative subsection}

\noindent {\bf expr1 \textbf{[} expr2 -: expr3 \textbf{]} \hfill backward relative subsection}
...
\noindent {\bf p \{ expr [; expr]* \} \hfill programmer defined control structure}
...
\hrule\vspace{0.1cm}
\noindent {\bf args(x,i) : any \hfill number of arguments}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf bal(cs:\&cset, cs:'(', cs:')', s, i, i) : integer* \hfill balance string}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf center(s, i:1, s:" ") : string \hfill center string}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf display(i:\&level, f:\&errout, CE:\&current) : null \hfill write variables}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf eventmask(CE, cset) : cset {\textbar} null \hfill \ \ \ \ \ \ \ \  get/set event mask}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf left(s, i:1, s:" ") : string \hfill left format string}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf load(s,L,f:\&input,f:\&output,f:\&errout,i,i,i) : co-expression \hfill load Unicon program}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf match(s, s:\&subject, i:\&pos, i:0) : integer \hfill match string}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf open(s, s:"rt", ...) : file? \hfill open file}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf right(s, i:1, s:" ") : string \hfill right format string}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf trim(s, c:' ', i:{}-1) : string \hfill trim string}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf where(f) : integer? \hfill file position}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf write(s{\textbar}f, ...) : string{\textbar}file \hfill write text line}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf writes(s{\textbar}f, ...) : string{\textbar}file \hfill write strings}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf CopyArea(w1, w2,x:0,y:0,width:0,height:0,x2:0,y2:0) : window \hfill copy area}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf DrawArc(w, x, y, width, height:width, a1:0.0, a2:2*\&pi, ...) : window \hfill draw arc}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf DrawCircle(w, x, y, radius, a1:0.0, a2:2*\&pi, ...) : window \hfill draw circle}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf DrawRectangle(w, x1, y1, width1, height1 ...) : window \hfill draw rectangle}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf DrawTorus(w, x, y, z, r1, r2, ...) : record \hfill draw torus}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf EraseArea(w, x:0, y:0, width:0, height:0. ...) : window \hfill erase rectangular area}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf FillArc(w, x, y, width, height, a1, a2, ...) : window \hfill draw filled arc}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf FillCircle(w, x, y, radius, a1, a2, ...) : window \hfill draw filled circle}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf FillRectangle(w, x:0, y:0, width:0, height:0, ...) : window \hfill draw filled rectangle}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf Pixel(w, x:0, y:0, width:0, height:0) : i1...in \hfill generate window pixels}
...
\bigskip\hrule\vspace{0.1cm}
\noindent {\bf Scale(w, x, y, z) : record \hfill\ scale objects}
