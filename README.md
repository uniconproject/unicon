...
**Preprocessor:** multi-line strings, function-like macros, and built-in `assert` / `assert_not` are documented in [**UTR #23** — `doc/utr23_preprocessor.md`](doc/utr23_preprocessor.md) (*The Unicon Preprocessor*).
