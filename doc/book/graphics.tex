...
\sffamily \texttt{\&lpress} &
Mouse press left\\\hline
\sffamily \texttt{\&mpress} &
Mouse press middle\\\hline
\sffamily \texttt{\&rpress} &
Mouse press right\\\hline
\sffamily \texttt{\&lrelease} &
Mouse release left\\\hline
\sffamily \texttt{\&mrelease} &
Mouse release middle\\\hline
\sffamily \texttt{\&rrelease} &
Mouse release right \\\hline
\sffamily \texttt{\&ldrag} &
Mouse drag left \\\hline
\sffamily \texttt{\&mdrag} &
Mouse drag middle \\\hline
\sffamily \texttt{\&rdrag} &
Mouse drag right \\\hline
\sffamily \texttt{\&resize} &
