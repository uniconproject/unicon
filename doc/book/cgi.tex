...
cgi["grail"]==='on'
\& "grail") \\
\>   cgiEcho("Your favorite color is: ",
cgi["color"]) \\
...
procedure cgimain() \\
\ \ fname := tempname("appform",
".txt",
"/tmp") \\
\ \ f :=
open("/tmp/"{\textbar}{\textbar}fname,
"w") {\textbar}
stop("can't open /tmp/",
fname) \\
...
\ \ system("cd /tmp; lpr "
{\textbar}{\textbar} fname; rm " {\textbar}{\textbar}
fname {\textbar}{\textbar} ".*") \\
