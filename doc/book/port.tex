...
PID of the child, and the child gets 0. An optional leading
network-namespace file (\texttt{fork(ns)}) joins that namespace in the
child before \texttt{fork()} returns.
