...
\iconcode{
procedure seqsel(a) \\
\>(*a = 2) {\textbar} stop("seqsel requires a list of two arguments") \\
\>e1 := a[1]; e2 := a[2] \\
...
\>oct := create((0 to 3) {\textbar}{\textbar} (0 to 7) {\textbar}{\textbar} (0 to 7)) \\
\>char := create image(!\&cset) \\
\>while write(@dec, "{\textbackslash}t", @oct, "{\textbackslash}t", @hex,
"{\textbackslash}t", @char) \\
end
}
