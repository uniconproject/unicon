...
{
  CURTSTATE();
/*dbg* fprintf(stderr, "*** rngLib has set error %d ***\n", n); fflush(stderr); */
...
function{0,1} rngbits(n)
   if !cnv:C_integer(n) then
      runerr(101,n)
   abstract { return new list(integer) }
   body {
     int elems;
...
/*dbg* fprintf(stderr, "%016lx%016lx\n", ap->a[0], ap->a[1]); fflush(stderr); */
         result.dword = D_List;
...
/*dbg*      fprintf(stderr, "*** Restart rngIcon ***\n"); fflush(stderr); */
      } else {
#ifndef Arrays
...
/*dbg*            fprintf(stderr, "%s is loaded\n", filename); fflush(stderr); */
...
/*dbg*          fprintf(stderr, "startRng() found\n"); fflush(stderr); */
...
/*dbg*          fprintf(stderr, "putSeed() found\n"); fflush(stderr); */
...
/*dbg*          fprintf(stderr, "getRandomFpt() found\n"); fflush(stderr); */
...
/*dbg*        fprintf(stderr, "Need an array with %d elements\n", elems); fflush(stderr); */
