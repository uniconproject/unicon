...
{\begin{tabular}{ | l | l | } \hline 
	...
	a run of letters & {\tt Span(\&letters)} \\ \hline
...
two occurrences of {\tt "a"} is matched. In the second statement, there is
...
\subsubsection{Arbno(): Match zero or more consecutive occurrences of pattern}
...
However this is not only inefficient, but also a possible maintenance
...
backtrack in search of other alternatives. However if the pattern call
...
patterns, or used in the pattern match (??) or string scanning
