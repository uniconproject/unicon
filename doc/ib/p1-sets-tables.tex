...
\put(0,176){\dvptrbox{table}{np}{40}{}}
...
%--%\ \  \includegraphics[width=1.1752in,height=1.6189in]{ib-img/ib-img040.jpg} \put(140,-32){\dvbox{integer}{n}{1}}
\begin{picture}(300,120)(0,-32)
...
\put(120,32){\brboxlabel{hash number}}
\put(120,48){\blkptrbox{tvtbl}{40}{table header block for t}}
\put(0,64){\dvptrbox{tvtbl}{nptv}{40}{}}
\end{picture}
...
%% large and small address spaces, respectively. 
...
\bluecode{
\>/* Unicon uses different code for string hashes.\\
\>\ * Neither the \#ifdef .. \#else ..\#endif or this comment\\
\>\ * is actually in the code. In reality, they are different source\\
\>\ * trees, but it makes it clear what the differences are.\\
\>\ */\\
\#ifdef Unicon\\
\>hashstring:\\
\>\> /*\\
...
most ten characters are used{\color{blue}\ (Unicon uses twenty)}, 
since strings can be very long and
