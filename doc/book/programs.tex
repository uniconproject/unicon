...
\texttt{\&}\index{null value, \&null}\texttt{null}. Other keywords
...
\index{every}\texttt{every} is a mechanism for processing the entire
...
clause}\texttt{initial} clause, which will execute only the first time
