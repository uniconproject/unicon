...
%-------------------------------------------------------------------------------
% Draw a word box (half height) with a hdr/null pointer symbol and a label
% \hdrnullptrbox{label}
\newcommand{\hdrnullptrbox}[1]{%
\begin{picture}(120,16)%
\put(0,0){\framebox(100,16){}}%          The box
\put(-2,4){\makebox(100,32)[br]{{\color{blue}hdr~/~}\o}}% hdr/Null ptr symbol
\put(10,8){\makebox(100,32)[br]{\makebox(0,0)[l]{#1}}}% label
\end{picture}%
}%
%-------------------------------------------------------------------------------
