...
\section{GA Operations: Fitness, Crossover, and Mutation}
...
\textsf{newpop}, and the process is ready to start again. Listing 17-1
...
\>   every 1 to 100 do  \\
\>   \ \ \ ga.evolve() \\
\>   write(log\_file, "best location ={\textgreater}
", ga.best) \\
...
Figure 17-2 is a screen snapshot of \textsf{cb}. The higher the user
...
hard to evolve into something more structured. Figure 17-3 shows
...
pages. Figure 17-4 is a snapshot of \textsf{cb} in text mode:
...
Figure 17-5 that demonstrates how to incorporate the selected color
