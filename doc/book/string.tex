...
\texttt{{\textquotedbl}the{\textquotedbl}} aren{\textquotesingle}t
...
procedure main() \\
\>   while line := read() do \\
\>   \ \ \ if expr(line) == line then write({\textquotedbl}Success!{\textquotedbl}) \\
...
={\textquotedbl}c{\textquotedbl} {\textbar}  ( ={\textquotedbl}({\textquotedbl}
{\textbar}{\textbar}
