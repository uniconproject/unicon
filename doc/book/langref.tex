...
\bigskip\hrule\vspace{0.1cm}
\noindent
{\bf \&syserr := integer } \hfill {\bf halt on system error}
...
\noindent
{\bf var1 {\textless}-{\textgreater} var2 } \hfill {\bf reversible swap}
...
\noindent
{\bf expr1 \textbf{[} expr2 : expr3 \textbf{]} } \hfill {\bf subsection}
...
\index{channel}
\noindent
{\bf channel(TH) : list } \hfill {\bf communicationsl channel}
...
\index{chdir}
\noindent
{\bf chdir(s) : string } \hfill {\bf change directory}
...
\index{copy}
\noindent
{\bf copy(any) : any } \hfill {\bf copy value}
...
\index{delete}
\noindent
{\bf delete(x1, x2, ...) : x1 } \hfill {\bf delete element}
...
\index{flock}
\noindent
{\bf flock(f, s) : ? } \hfill {\bf apply or remove file lock}
...
\index{get}
\noindent
{\bf get(L,i:1) : any? } \hfill {\bf get element from queue}
...
\index{insert}
\noindent
{\bf insert(x1, x2, x3:\&null) : x1 } \hfill {\bf insert element}
...
\index{key}
\noindent
{\bf key(x) : any* } \hfill {\bf table keys}
...
\index{pop}
\noindent
{\bf pop(L {\textbar} Message) : any? } \hfill {\bf pop from stack}
...
\index{pull}
\noindent
{\bf pull(L,i:1) : any? } \hfill {\bf remove from list end}
...
\index{push}
\noindent
{\bf push(L, any, ...) : list } \hfill {\bf push on to stack}
...
\index{put}
\noindent
{\bf put(L, x1, ..., xN) : list } \hfill {\bf add to list end}
...
\textit{symbol} } \hfill {\bf conditional compilation}
\linebreak
...
[\textit{filename}] } \hfill {\bf source code line}
