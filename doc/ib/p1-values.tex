...
\put(0,0){\dvbox{\textit{n}}{}{}}
\put(110,28){length}
\put(80,12){\vector(1,0){50}}
\put(140,12){\makebox(70,2)[r]{first character}}
\end{picture}
\end{center}
...
\put(110,28){length}
\put(80,12){\vector(1,0){50}}
\put(140,12){\makebox(36,2)[r]{"hello"}}
\end{picture}
\end{center}
...
\put(0,32){\dvbox{long}{np}{}}
\put(140,0){\blklrgbox{long}{80000}}
\put(78,45){\vector(1,0){65}}
\put(255,43){title}
\end{picture}
...
\put(0,112){\dvbox{record}{np}{}}
\put(140,96){\blkbox{record}{32}}
\put(78,126){\vector(1,0){65}}
\put(140,64){\dvbox{proc}{np}{}}
\put(140,32){\dvbox{integer}{n}{1}}
\put(140,0){\dvbox{integer}{n}{3}}
\put(260,122){title}
\put(260,106){size of block in bytes}
\put(218,77){\vector(1,0){65}}
\put(290,74){record-constructor block}
\end{picture}
...
\put(0,144){\dvbox{record}{np}{}}
\put(140,128){\blkbox{record}{40}}
\put(78,158){\vector(1,0){65}}
\put(140,96){\dvbox{proc}{np}{}}
\put(140,64){\dvbox{5}{}{}}
\put(140,32){\dvbox{4}{}{}}
\put(140,0){\dvbox{integer}{n}{4}}
\put(260,154){title}
\put(260,138){size of block}
\put(218,109){\vector(1,0){65}}
\put(290,107){record-constructor block}
\put(218,77){\vector(1,0){65}}
\put(290,75){"chair"}
\put(218,45){\vector(1,0){65}}
\put(290,43){"noun"}
\end{picture}
...
\put(0,80){\dvbox{tvkywd}{nptv}{}}
\put(78,94){\vector(1,0){65}}
\put(140,64){\blkbox{tvkywd}{}}
\put(218,78){\vector(1,0){65}}
\put(290,76){assignment function}
\put(140,32){\dvbox{integer}{n}{0}}
\put(140,0){\dvbox{6}{}{}}
\put(218,13){\vector(1,0){65}}
\put(290,11){"\&trace"}
\end{picture}
...
\>\#define D\_Long\ \ \ \ (T\_Long | F\_Ptr | F\_Nqual)\\
