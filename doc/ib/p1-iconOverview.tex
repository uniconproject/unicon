...
\iconline{ % this one was fixed up manually ... it's just too weird for the automatic convertor
...
\ \ \ \texttt{tab(i)}\ \ \ \ set the position in the subject to i\newline
 \ \ \texttt{move(i)}\ \ increment the position in the subject by i
...
The formal parameter slist and the identifiers max and value are local to
...
\noindent calls f(10), f(11), f(12), f(13), and f(14).
