...
\put(120,64){\dvbox{null}{n}{0}}
\put(120,64){\trboxlabel{descriptor for result (Arg0)}}
\put(120,32){\dvptrbox{5}{}{40}{"aeiou"}}
\put(120,32){\trboxlabel{argument of random (Arg1)}}
\put(120,32){\downbars}
\put(120,32){\lregptr{sp}{20}}
\end{picture}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Reinstate a missing page from the Icon IB here (P114)    %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\put(120,0){\lregptr{sp}{20}}
\put(120,0){\dvptrbox{null}{nvp}{40}{}}
\put(120,0){\downbars}
...
\put(120,176){\upetc}
\end{picture}
}% No idea why the next put must be 121 not 120
\put(121,0){\dvptrbox{0}{nvp}{40}}
...
\put(120,0){\dvptrbox{0}{nvp}{40}{local i}}
\put(120,0){\lregptr{sp}{20}}
\put(120,0){\downbars}
\put(120,32){\dvbox{null}{n}{0}}
\put(120,32){\upetc}
