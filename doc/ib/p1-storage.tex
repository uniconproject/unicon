...
% [DonW] LaTeX is not completely happy(tm) when \index commands are
% mixed up with \hline commands
\begin{noIndex}
...
{\color{blue} Concurrent programs in Unicon do not share their string
or block regions between threads (after this was found to be a
...
to each other's data strcutures which makes it necessary to suspend all
